...
public class HistoryController {
	 ...
	 * 
	 * @GetMapping("/showAddress") public String showAllAddresses(Model model) {
	 * model.addAttribute("addresses", addressService.findAll()); return
	 * "/showAddress"; }
	 */
	 ...
	 * 
	 * @RequestMapping(value = "showAddress/{id}", method = {RequestMethod.DELETE,
	 * RequestMethod.GET }) public String deleteAddress(@PathVariable Long id) {
	 * addressService.deleteById(id); return "redirect:"; }
	 */
